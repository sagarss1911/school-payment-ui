...
export class BilldeskService {
  mid: any = "STEWARTSCH";
  sec_id: any = "stewartsch";
  checksum_key: any = "bDYpoShI92SIqiW1OqVzQiiP37Sgd5d1";
  reverse_url: any;
  ...
  get_message(uniqueID, amount, some_id, mail, fname, mnumber) {
    let msg = `${this.mid}|${uniqueID}|NA|${amount.toFixed(2)}|NA|NA|NA|INR|NA|R|${this.sec_id}|NA|NA|F|${fname}|${some_id}|${mail}|${mnumber}|NA|NA|NA|NA`;
